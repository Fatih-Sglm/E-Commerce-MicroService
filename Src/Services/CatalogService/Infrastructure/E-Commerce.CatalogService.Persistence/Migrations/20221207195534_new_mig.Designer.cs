...
namespace ECommerce.CatalogService.Persistence.Migrations
{
    ...
    [Migration("20221207195534_new_mig")]
            ...
            modelBuilder.Entity("E_Commerce.CatalogService.Domain.Entities.CatalogBrand", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedDate = new DateTime(2022, 12, 7, 22, 55, 34, 5, DateTimeKind.Local).AddTicks(1141),
                            Name = "Nike"
                        },
                        new
                        {
                            Id = 2L,
                            CreatedDate = new DateTime(2022, 12, 7, 22, 55, 34, 5, DateTimeKind.Local).AddTicks(1154),
                            Name = "Adidas"
                        },
                        new
                        {
                            Id = 3L,
                            CreatedDate = new DateTime(2022, 12, 7, 22, 55, 34, 5, DateTimeKind.Local).AddTicks(1156),
                            Name = "Puma"
                        });
                });
            ...
            modelBuilder.Entity("E_Commerce.CatalogService.Domain.Entities.CatalogItem", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CatalogBrandId = 1L,
                            CatalogTypeId = 1L,
                            CreatedDate = new DateTime(2022, 12, 7, 22, 55, 34, 5, DateTimeKind.Local).AddTicks(9459),
                        ...
                        new
                        {
                            ...
                            CatalogBrandId = 1L,
                            CatalogTypeId = 2L,
                            CreatedDate = new DateTime(2022, 12, 7, 22, 55, 34, 5, DateTimeKind.Local).AddTicks(9469),
            ...
            modelBuilder.Entity("E_Commerce.CatalogService.Domain.Entities.CatalogItemImage", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            CatalogItemId = 1L,
                            CreatedDate = new DateTime(2022, 12, 7, 22, 55, 34, 6, DateTimeKind.Local).AddTicks(3017),
                        ...
                        new
                        {
                            Id = 2L,
                            CatalogItemId = 2L,
                            CreatedDate = new DateTime(2022, 12, 7, 22, 55, 34, 6, DateTimeKind.Local).AddTicks(3026),
            ...
            modelBuilder.Entity("E_Commerce.CatalogService.Domain.Entities.CatalogType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedDate = new DateTime(2022, 12, 7, 22, 55, 34, 7, DateTimeKind.Local).AddTicks(617),
                            Name = "Shoes"
                        },
                        new
                        {
                            Id = 2L,
                            CreatedDate = new DateTime(2022, 12, 7, 22, 55, 34, 7, DateTimeKind.Local).AddTicks(625),
                            Name = "T-Shirt"
                        },
                        new
                        {
                            Id = 3L,
                            CreatedDate = new DateTime(2022, 12, 7, 22, 55, 34, 7, DateTimeKind.Local).AddTicks(627),
                            Name = "tracksuit"
                        });
                });
