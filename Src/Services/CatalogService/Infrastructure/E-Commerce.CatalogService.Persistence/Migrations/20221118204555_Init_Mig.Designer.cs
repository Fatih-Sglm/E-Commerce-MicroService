...
namespace ECommerce.CatalogService.Persistence.Migrations
{
    ...
    [Migration("20221118204555_Init_Mig")]
            ...
            modelBuilder.Entity("CatalogItemCatalogItemVariant", b =>
                {
                    ...
                    b.ToTable("CatalogItemCatalogItemVariant", "catalog");
                });
            ...
            modelBuilder.Entity("E_Commerce.CatalogService.Domain.Entities.CatalogBrand", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedDate = new DateTime(2022, 11, 18, 23, 45, 55, 198, DateTimeKind.Local).AddTicks(7855),
                            Name = "Nike"
                        },
                        new
                        {
                            Id = 2L,
                            CreatedDate = new DateTime(2022, 11, 18, 23, 45, 55, 198, DateTimeKind.Local).AddTicks(7874),
                            Name = "Adidas"
                        },
                        new
                        {
                            Id = 3L,
                            CreatedDate = new DateTime(2022, 11, 18, 23, 45, 55, 198, DateTimeKind.Local).AddTicks(7876),
                            Name = "Puma"
                        });
                });
            ...
            modelBuilder.Entity("E_Commerce.CatalogService.Domain.Entities.CatalogItem", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CatalogBrandId = 1L,
                            CatalogTypeId = 1L,
                            CreatedDate = new DateTime(2022, 11, 18, 23, 45, 55, 200, DateTimeKind.Local).AddTicks(173),
                        ...
                        new
                        {
                            ...
                            CatalogBrandId = 1L,
                            CatalogTypeId = 2L,
                            CreatedDate = new DateTime(2022, 11, 18, 23, 45, 55, 200, DateTimeKind.Local).AddTicks(190),
            ...
            modelBuilder.Entity("E_Commerce.CatalogService.Domain.Entities.CatalogItemImage", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            CatalogItemId = 1L,
                            CreatedDate = new DateTime(2022, 11, 18, 23, 45, 55, 200, DateTimeKind.Local).AddTicks(9655),
                        ...
                        new
                        {
                            Id = 2L,
                            CatalogItemId = 2L,
                            CreatedDate = new DateTime(2022, 11, 18, 23, 45, 55, 200, DateTimeKind.Local).AddTicks(9673),
            ...
            modelBuilder.Entity("E_Commerce.CatalogService.Domain.Entities.CatalogType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedDate = new DateTime(2022, 11, 18, 23, 45, 55, 202, DateTimeKind.Local).AddTicks(2373),
                            Name = "Shoes"
                        },
                        new
                        {
                            Id = 2L,
                            CreatedDate = new DateTime(2022, 11, 18, 23, 45, 55, 202, DateTimeKind.Local).AddTicks(2387),
                            Name = "T-Shirt"
                        },
                        new
                        {
                            Id = 3L,
                            CreatedDate = new DateTime(2022, 11, 18, 23, 45, 55, 202, DateTimeKind.Local).AddTicks(2390),
                            Name = "tracksuit"
                        });
                });
